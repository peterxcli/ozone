...
/**
 * Observer for ReadBlock transports that can carry response metadata and data
 * bytes separately.
 */
public interface ReadBlockStreamObserver
    extends StreamObserver<ContainerCommandResponseProto> {
