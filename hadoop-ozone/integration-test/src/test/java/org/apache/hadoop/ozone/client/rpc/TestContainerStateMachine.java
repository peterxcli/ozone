...
public class TestContainerStateMachine {
  ...
  private static void assertSnapshotsWithinRetention(SimpleStateMachineStorage storage,
    ...
    File snapshotFile = storage.getLatestSnapshot().getFile().getPath().toFile();
    MD5FileUtil.verifySavedMD5(snapshotFile, MD5FileUtil.computeMd5ForFile(snapshotFile));
  }
}
